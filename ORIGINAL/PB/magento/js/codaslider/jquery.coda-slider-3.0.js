	...
	var Slider = {
		...
		addArrows: function(){
			...
			if(self.options.dynamicArrowsGraphical){
				...
				$(self.sliderId).before('<div class="coda-nav-left" data-dir="prev"><a href="#">&nbsp;</a></div>');
				$(self.sliderId).after('<div class="coda-nav-right" data-dir="next"><a href="#">&nbsp;</a></div>');
			}
		},
		...
		setCurrent: function( direction ){
			...
			if (self.clickable) {
				...
				$($(self.sliderId).parent()).find('.tab' + (self.setTab + 1))
